...
RSpec.describe ItemsController, type: :controller do
  ...
  let(:valid_attributes) {
    { name: 'itemname', list_id: 1, user_id: 1 }
  }
...
=end
  ...
  describe "when logged in" do
    ...
    describe "POST #create" do
      ...
      # Create list so it's possible to redirect back to it
      before :each do
        List.create! id:1, user_id:1, name:'test'
      end
      ...
      context "with valid params" do
        ...
        it "redirects to the created items list" do
          post :create, {:item => valid_attributes}, valid_session
          expect(response).to redirect_to(Item.last.list)
        end
      end
